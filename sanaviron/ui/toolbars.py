...
class HorizontalToolbar(Toolbar):
    ...
    def __init__(self):
        ...
        self.append_to_submenu(ALIGN_OBJECTS_CENTER_BOTH, "align-object-center_both")
        self.append_to_submenu(ALIGN_OBJECTS_EAST, "align-object-east")
        self.append_to_submenu(ALIGN_OBJECTS_CENTER_HORIZONTAL, "align-object-center_horizontal")
        self.append_to_submenu(ALIGN_OBJECTS_CENTER_VERTICAL, "align-object-center_vertical")
        ...
        self.append_to_submenu(ALIGN_PAPER_CENTER_BOTH, "align-paper-center_both")
        self.append_to_submenu(ALIGN_PAPER_EAST, "align-paper-east")
        self.append_to_submenu(ALIGN_PAPER_CENTER_HORIZONTAL, "align-paper-center_horizontal")
        self.append_to_submenu(ALIGN_PAPER_CENTER_VERTICAL, "align-paper-center_vertical")
